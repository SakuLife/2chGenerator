...
# 【重要】テーマのバランス（必ず守ること）
以下の3カテゴリを均等に混ぜること：
1. 成功・達成系（全体の約4割）：資産形成成功、投資で増えた、FIRE達成、貯金達成、年収アップなど前向きな話
2. 失敗・損失系（全体の約3割）：投資失敗、借金、浪費など
3. 知識・ノウハウ系（全体の約3割）：節約術、投資の始め方、制度活用など実用的な情報

※失敗系ばかりにしないこと。成功体験や資産が増えた話を多めに入れること。
